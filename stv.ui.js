...
ui.table=function(){
	...
	table.row=function(){
		var tr=document.createElement("tr");for(var i=0;i<arguments;i++){
...
ui.readfile =function(calb,fileext){
	var ip = document.createElement("input");
	ip.type="file";
...
ui.style.parsecss=function(txt){
	...
	for(var i=0;i<obj.length;i++){
		...
		if(_t != ""){
			...
			css[express[0].replace(/(\-[a-z])/g, function(a,b){ return b[1].toUpperCase() })] = _t[1] || ""; 
		}
	}
	return css;
}
